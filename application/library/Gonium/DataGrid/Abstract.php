...
require_once 'Gonium/DataGrid/Abstract/Interface.php';
 ...
 * @version     $Id: Abstract.php 5 2009-05-11 04:08:28Z gnzsquall $
 */
abstract class Gonium_DataGrid_Abstract 
    implements Gonium_DataGrid_Abstract_Interface, Countable, IteratorAggregate
{
	...
	public function setLimit($limit = null)
	{
		...
		if( !is_int($limit) && ($limit < 0) ) {
			/**
			 * @see Gonium_DataGrid_Abstract_Exception
			 */
			require_once 'Gonium/DataGrid/Abstract/Exception.php';
			throw new Gonium_DataGrid_Abstract_Exception('Invalid number of records ' . $limit);
		}
	...
	protected function setNumberRecords() {
		if(null === $this->_numberRecords){
			if (null !== $this->getDataSource()) {
				 ...
				 */
				require_once 'Gonium/DataGrid/Abstract/Exception.php';
				throw new Gonium_DataGrid_Abstract_Exception("Cannot fetch data: no datasource driver loaded.");
			}
		}
	}
	...
	public function fetch()
	{
		try{
			 ...
			 */
			require_once 'Gonium/DataGrid/Abstract/Exception.php';
			throw new Gonium_DataGrid_Abstract_Exception("Message Exception: " . $e->getMessage() . "\n");
		}
		return $this;
	}

	public function bindDataSource(Gonium_DataGrid_DataSource_Interface $source)
	{
     ...
     * 
     * @author {@link http://labs.gon.cl/gonium Gonzalo Diaz}
     * @param Gonium_DataGrid_Pager_Abstract|string $pagerAdapter 
     *  name or instance of a Pager Adapter
     * @return Gonium_DataGrid_Abstract
     */
    public function setPager($pagerAdapter = null)
    {
        if($pagerAdapter instanceof Gonium_DataGrid_Pager_Abstract)
        {
            $this->_pagerAdapter = $pagerAdapter;
        } else {
            $this->_pagerAdapter = Gonium_DataGrid_Pager::factory(
              $pagerAdapter, 
              $this->getPage(), 
              $this->getLimit(), 
