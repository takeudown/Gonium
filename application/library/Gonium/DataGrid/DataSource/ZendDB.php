 ...
 * Zsamer Framework
 *
 * Gonium_DataGrid_DataSource_ZendDB
 *
 ...
 * @version     $Id: ZendDB.php 5 2009-05-11 04:08:28Z gnzsquall $
 */
 ...
 * @version     $Id: ZendDB.php 5 2009-05-11 04:08:28Z gnzsquall $
 */
class Gonium_DataGrid_DataSource_ZendDB implements Gonium_DataGrid_DataSource_Interface
{
	...
	public function __construct($query)
	{
		...
		if(!is_string($query)){
			require_once 'Gonium/DataGrid/DataSource/Exception.php';
			throw new Gonium_DataGrid_DataSource_Exception('Gonium_DataGrid_DataSource_ZendDB: Query parameter must be a string');
		}
