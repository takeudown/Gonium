...
/** @see Gonium_DataGrid_Interface */
require_once 'Gonium/DataGrid/Interface.php';
...
class Gonium_DataGrid
    ...
    implements Gonium_DataGrid_Interface
{
	...
	public function __construct(Gonium_DataGrid_DataSource_Interface $dataSource = null, $limit = null, array $_params = array())
	{
		$this->setLimit($limit);
	...
	protected function _fetch()
	{
		...
		if (null === $this->getDataSource()) {
			 ...
			 */
			require_once 'Gonium/DataGrid/Exception.php';
			throw new Gonium_DataGrid_Exception("Cannot fetch data: no datasource driver loaded.");
		}
		...
		if(!empty($columnId) && !empty($dir)){
			 ...
			 */
			require_once 'Gonium/DataGrid/Exception.php';
			throw new Gonium_DataGrid_Exception("Cannot sort data: OrderBy or Direction are empty.");
		}
	 ...
	 * @param   $column array |Gonium_DataGrid_Column $column
	 * @return  Gonium_DataGrid
	 */
	public function addColumn($columnId, $column)
	{
		Zend_Loader::loadClass('Gonium_DataGrid_Column');
		
		if (is_array($column)) {
			$this->_columns[$columnId] = new Gonium_DataGrid_Column();
			$this->_columns[$columnId]->setData($column);
		} else if($column instanceof Gonium_DataGrid_Column) {
			 ...
			 */
			require_once 'Gonium/DataGrid/Exception.php';
			throw new Gonium_DataGrid_Exception('Wrong column format');
		}
	 ...
	 *
	 * @param   string $columnId
	 * @return  Gonium_DataGrid_Column | false
	 */
	...
	protected function _render($adapterName = null)
	{
		if (empty($this->_columns)){
			 ...
			 */
			require_once 'Gonium/DataGrid/Exception.php';
			throw new Gonium_DataGrid_Exception("Cannot render columns: the columns are empty.");
		}

		Zend_Loader::loadClass('Gonium_DataGrid_Render');
		
		return Gonium_DataGrid_Render::factory($this, $adapterName)->render();
	}
}
