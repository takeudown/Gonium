 ...
 * @version     $Id: Dock.php 5 2009-05-11 04:08:28Z gnzsquall $
 */
 ...
 * @copyright   2008 {@link http://labs.gon.cl/gonium Gonzalo Diaz Cruz}
 * @version     $Id: Dock.php 5 2009-05-11 04:08:28Z gnzsquall $
 * @todo		This script has a high dependence on the implementation, , but is a library class.
 */
class Gonium_Widget_Dock {
	...
	private function widgetName(Gonium_Widget $widget) {
		$name = get_class ( $widget );
		return str_replace ( 'Widget_', '', $name );
	}
	
	public function register(Gonium_Widget $widget, $instanceName = null, Zend_View $view = null) {
		if (is_null ( $view ))
