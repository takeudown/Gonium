 ...
 * @version     $Id: ZendDB.php 115 2008-12-03 03:01:49Z gnzsquall $
 */
class Rox_DataGrid_DataSource_ZendDB implements Rox_DataGrid_DataSource_Interface
{
	...
	public function __construct($query)
	{
		...
		if(!is_string($query)){
			require_once 'Rox/DataGrid/DataSource/Exception.php';
			throw new Rox_DataGrid_DataSource_Exception('Rox_DataGrid_DataSource_ZendDB: Query parameter must be a string');
		}
