...
class Rox_DataGrid_Column
{
	...
	protected function _getRendererByType()
	{
		switch (strtolower($this->getType())) {
			case 'number':
				$rendererClass = 'Rox_DataGrid_Column_Renderer_Number';
				break;
			case 'action':
				$rendererClass = 'Rox_DataGrid_Column_Renderer_Action';
				break;
			case 'options':
				$rendererClass = 'Rox_DataGrid_Column_Renderer_Options';
				break;
			case 'text':
				$rendererClass = 'Rox_DataGrid_Column_Renderer_Longtext';
				break;
			case 'link':
				$rendererClass = 'Rox_DataGrid_Column_Renderer_Link';
				break;
			default:
				$rendererClass = 'Rox_DataGrid_Column_Renderer_Text';
				break;
		}
