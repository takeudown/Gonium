 ...
 * @subpackage  Rox_Controller_Action_Helper
 * @author      {@link http://blog.gon.cl/cat/zf Gonzalo Diaz Cruz}
 * @license     http://www.gnu.org/licenses/old-licenses/gpl-2.0.html GNU/GPL v2
 * @copyright   2008 {@link http://labs.gon.cl/gonium Gonzalo Diaz Cruz}
 * @version     $Id: LoadModel.php 153 2009-05-10 21:20:21Z gnzsquall $
 */
 ...
 */
class Rox_Controller_Action_Helper_LoadModel extends Zend_Controller_Action_Helper_Abstract
{
    ...
    {
        return rtrim($prefix, CLASS_SEPARATOR) . CLASS_SEPARATOR .
            Rox_Controller_Action_Helper_LoadModel::MODEL_PREFIX;
    }
    ...
    public static function getNewModel($name, $altPrefix ='')
    {
        ...
        Zend_Loader::loadClass('Rox_Model_Exception');
        throw new Rox_Model_Exception(sprintf(
