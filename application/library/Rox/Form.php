 ...
 * @version     $Id: Form.php 153 2009-05-10 21:20:21Z gnzsquall $
 */
 ...
 * @version     $Id: Form.php 153 2009-05-10 21:20:21Z gnzsquall $
 */
class Rox_Form extends Zend_Form {
	/**
	...
	public function setStyle($style) {
		if (! ($style instanceof Rox_Form_Style_Interface)) {
			$style = 'Rox_Form_Style_' . ucfirst ( $style );
