 ...
 * @version     $Id: UserSession.php 153 2009-05-10 21:20:21Z gnzsquall $
 */
 ...
 * @version     $Id: UserSession.php 153 2009-05-10 21:20:21Z gnzsquall $
 */
class Rox_Auth_Storage_UserSession
    implements Zend_Auth_Storage_Interface
{
    ...
    public function isEmpty()
    {
        return
               ...
               // o si el miembro no es un Rox_User
            || !( $this->_session->{$this->_member} instanceof Rox_User )
    ...
    {
        if($contents instanceof Rox_User)
        {
        	$this->_session->{$this->_member} = $contents;
        } else
        if($this->_throwExceptions){
        	throw new Rox_Auth_Exception('User data does\'t provided');
        }
    }
