 ...
 * @version     $Id: Login.php 153 2009-05-10 21:20:21Z gnzsquall $
 */
 ...
 * @version     $Id: Login.php 153 2009-05-10 21:20:21Z gnzsquall $
 */
class Widget_Login extends Rox_Widget {

	public function execute() {
		$auth = Zend_Registry::get ( 'core_auth' );
		...
		if ( !$auth->hasIdentity() )
		{
			try {
				...
				$openidForm = new Rox_Form_Prepared_OpenId();
			...
			Zend_Loader::loadClass ( 'Rox_Form_Prepared_Logout' );
			$form = new Rox_Form_Prepared_Logout ( );
			$form->setStyle('Div');
			$form->setAttrib ( 'id', 'widget-user-auth' );
