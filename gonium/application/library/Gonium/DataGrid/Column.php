 ...
 * @version     $Id: Column.php 5 2009-05-11 04:08:28Z gnzsquall $
 */
...
class Gonium_DataGrid_Column
{
	...
	protected function _getRendererByType()
	{
		switch (strtolower($this->getType())) {
			case 'number':
				$rendererClass = 'Gonium_DataGrid_Column_Renderer_Number';
				break;
			case 'action':
				$rendererClass = 'Gonium_DataGrid_Column_Renderer_Action';
				break;
			case 'options':
				$rendererClass = 'Gonium_DataGrid_Column_Renderer_Options';
				break;
			case 'text':
				$rendererClass = 'Gonium_DataGrid_Column_Renderer_Longtext';
				break;
			case 'link':
				$rendererClass = 'Gonium_DataGrid_Column_Renderer_Link';
				break;
			default:
				$rendererClass = 'Gonium_DataGrid_Column_Renderer_Text';
				break;
		}
