...
class GoniumCore_Plugin_Backend_Action extends Zend_Controller_Plugin_Abstract
{
  public function dispatchLoopStartup(Zend_Controller_Request_Abstract $request)
  {
    ...
    Zend_Controller_Action_HelperBroker::addPath(
      'GoniumCore/Module/Admin/'.$module.'/helpers',
      'GoniumCore_Module_Admin_'.ucfirst($module).'_Helper_'
    );
    ...
    Gonium_Controller_Action_Helper_LoadModel::addPath(
      'GoniumCore/Module/Admin/'.$module.'/models',
      'GoniumCore_Module_Admin_'.ucfirst($module).'_Model_'
    );
    */
  }
}
