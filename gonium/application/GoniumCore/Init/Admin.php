 ...
 * @copyright   2008 {@link http://labs.gon.cl/gonium Gonzalo Diaz Cruz}
 */
class GoniumCore_Init_Admin extends GoniumCore_Init_Abstract
{
	/**
    ...
    public function initPlugins()
    {
        ...
        $plugins = array(
            'GoniumCore_Init_Plugin_Backend_View' => null,
            ...
            'GoniumCore_Init_Plugin_Backend_Action' => null,
    ...
    public function initRoutes()
    {
        ...
        try {
            ...
            $config = new Zend_Config_Ini( Core::getRootDir() . '/etc/directories.ini', 'admin');
            // Config Module Directories
            // Use section [admin] of etc/directories.ini
            {
                foreach($config as $modules)
                {
                    $frontController->addModuleDirectory( Core::expandConstants( $modules ) );
                }
            }
